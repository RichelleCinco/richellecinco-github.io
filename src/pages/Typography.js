    ...
    return (
      <>
        ...
        <div className="content">
          ...
          <p>Boop was my first project designing a font using Fontstruct, a font-building online tool using modular blocks or geometric shapes as
            part of the design constraint. While it added another layer of challenge, I was set on creating something that would be more fluid and organic.</p>
          <p>The second typeface I created was Ophelia. During the pandemic, I watched one too many Netflix movies that I couldn’t help but create a font for a
